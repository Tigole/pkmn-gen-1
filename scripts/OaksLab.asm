...
OaksLab_TextPointers:
	...
	dw_const OaksLabStarter1PokeBallText,       TEXT_OAKSLAB_STARTER1_POKE_BALL
	dw_const OaksLabStarter2PokeBallText,         TEXT_OAKSLAB_STARTER2_POKE_BALL
...
OaksLab_TextPointers2:
	dw OaksLabRivalText
	dw OaksLabStarter1PokeBallText
	dw OaksLabStarter2PokeBallText
...
OaksLabStarter1PokeBallText:
	...
	ld a, STARTER1
	ld b, OAKSLAB_STARTER1_POKE_BALL
	jr OaksLabSelectedPokeBallScript

OaksLabStarter2PokeBallText:
	text_asm
	ld a, STARTER3
	ld [wRivalStarterTemp], a
...
OaksLabBulbasaurPokeBallText:
	...
	ld a, STARTER1
	ld [wRivalStarterTemp], a
	ld a, OAKSLAB_STARTER1_POKE_BALL
	ld [wRivalStarterBallSpriteIndex], a
	ld a, STARTER3
...
OaksLabShowPokeBallPokemonScript:
	...
	ld a, [wSpriteIndex]
	cp OAKSLAB_STARTER1_POKE_BALL
	jr z, .OaksLabYouWantStarter1Text
	cp OAKSLAB_SQUIRTLE_POKE_BALL
	jr z, OaksLabYouWantSquirtleText
	jr OaksLabYouWantBulbasaurText

.OaksLabYouWantStarter1Text:
	ld hl, .Text
	jr OaksLabMonChoiceMenu
.Text:
	text_far _OaksLabYouWantStarer1Text
	text_end
