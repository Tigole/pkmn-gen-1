	...
	const_export OAKSLAB_STARTER1_POKE_BALL
...
OaksLab_Object:
	...
	object_event  6,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_OAKSLAB_STARTER1_POKE_BALL
	object_event  7,  3, SPRITE_POKE_BALL, STAY, NONE, TEXT_OAKSLAB_STARTER2_POKE_BALL
